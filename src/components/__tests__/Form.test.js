...
describe("Form", ()=> {
  ...
  /**
   * Replace the "calls onSave function when the name is defined" and the 
   * "submits the name entered by the user" tests with the "can successfully 
   * save after trying to submit an empty student name" test.
   */
  // it("calls onSave function when the name is defined", () => {
  //   const onSave = jest.fn();

  //   const { queryByText, getByText } = render(
  //     <Form interviewers={interviewers} interviewer={1} onSave={onSave} name="Lydia Miller-Jones"  />
  //   );
